...
<div class="menu-mobile">
    ...
    <div class="sicial-icon-mob-menu">
        <p><b>Телефон:</b> +7 (926) 434 86 43</p>
        <p><b>Email:</b> hello@wineandprose.ru</p>
        <a href="#" class="vk"></a>
        <a href="#" class="inst"></a>
    </div>
</div>
        ...
        <div class="flex-container grey-fon">
            <div class="col w50">
                <div class="wrapper-text height-616">
                    ...
                    <p class="p">Задачи, методики и лайфхаки, которые помогут тебе написать<br> книгу с нуля самостоятельно или закончить начатую.</p>
        ...
        <div id="company_anchor" class="flex-container">
            ...
            <div class="col w50">
                <div class="wrapper-text top-padd-96">
                    ...
                    <h2 class="h2">Альма-матер для <br>современных авторов</h2>
                    <p>Мы решили создать место, куда можно прийти со своей литературной проблемой и получить решение.</p>
                    <p>Наша миссия — помогать авторам писать действительно хорошие книги.</p>
                    <p>Мы верим, что с каждой такой книгой мир становится чуточку лучше, а миллионы людей находят в литературе ответы на важные вопросы.</p>
        ...
        <div id="blog_anchor" class="flex-container">
            ...
            <div class="col w50">
                <div class="wrapper-text top-padd-96">
                    ...
                    <h2 class="h2">Александра Гылка</h2>
                    ...
                    <div class="swiper-container">
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                ...
                                <p>Работал с Wine&Prose с 2017 года. Все было отлично.<br>
                                   Индивидуальный подход и креатив — вот за что я люблю вас.<br>
                                   Отдельное спасибо Александре! Благодаря ей я наконец закончил свой роман «Less».<br>
                                </p>
                                <p>А уже в 2018 г. я стал лауреатом Пулитцеровской премии по литературе в номинации «За художественную книгу» с формулировкой «За великодушную книгу о старении и сущности любви, музыкальную в своей прозе и обширную по структуре и размаху». Эта книга и есть тот самый роман «Less».</p>
                            </div>
                            <div class="swiper-slide">
                                <div class="client_feedback">
                                    <div class="client_pfoto" style='background-image: url("img/client-pfoto.png")'></div>
...
<div class="modal__wrapper write_book__modal hidden">
    <div data-simplebar class="modal_center__container">
        ...
        <form id="write_book_form"  name="mail_form" onsubmit="return false;">
            ...
            <p class="form_info">Нажимая кнопку “Оставить заявку” вы даете согласие на обработку своих персональных данных в соответствии с Политикой конфиденциальности</p>
...
<div class="modal__wrapper hidden take_check-list__modal">
    <div data-simplebar class="modal_center__container">
        ...
        <form id="check_list_form" action="" method="" onsubmit="return false;">
            ...
            <p class="form_info">Нажимая кнопку “Получить бесплатно” вы даете согласие на обработку своих персональных данных в соответствии с Политикой конфиденциальности</p>
    ...
    <div data-simplebar class="modal_center__container right_stuck_modal">
        ...
        <form action="#" onsubmit="return false;">
            ...
            <div class="wrapper_janr">
                ...
                <label><input type="checkbox" class="chekbox_rd_button" value="Художественная литература. 100 стр. / 1,5 месяца - 123 456 руб."> <p class="work_price"><span class="book_content">100 стр. / 1,5 месяца</span><span class="book_price">123 456 руб.</span></p></label>

                <label><input type="checkbox" class="chekbox_rd_button" value="Художественная литература. 200 стр. / 1,5 месяца - 123 456 руб."> <p class="work_price"><span class="book_content">100 стр. / 1,5 месяца</span><span class="book_price">123 456 руб.</span></p></label>

                <label><input type="checkbox" class="chekbox_rd_button" value="Художественная литература. 300 стр. / 1,5 месяца - 123 456 руб."> <p class="work_price"><span class="book_content">100 стр. / 1,5 месяца</span><span class="book_price">123 456 руб.</span></p></label>
            </div>
            <div class="wrapper_janr">
                <p>Простые жанры (детектив, любовный роман, мистика, приключения, триллер, боевик)</p>

                <label><input type="checkbox" class="chekbox_rd_button" value="Простые жанры. 100 стр. / 1,5 месяца - 123 456 руб."> <p class="work_price"><span class="book_content">100 стр. / 1,5 месяца</span><span class="book_price">123 456 руб.</span></p></label>

                <label><input type="checkbox" class="chekbox_rd_button" value="Простые жанры. 200 стр. / 1,5 месяца - 123 456 руб."> <p class="work_price"><span class="book_content">100 стр. / 1,5 месяца</span><span class="book_price">123 456 руб.</span></p></label>

                <label><input type="checkbox" class="chekbox_rd_button" value="Простые жанры. 300 стр. / 1,5 месяца - 123 456 руб."> <p class="work_price"><span class="book_content">100 стр. / 1,5 месяца</span><span class="book_price">123 456 руб.</span></p></label>
            </div>
            <div class="wrapper_janr">
                <h3 class="h3">Нон-фикшн</h3>
                <p>Нехудожественная литература</p>

                <label><input type="checkbox" class="chekbox_rd_button" value="Нон-фикшн. 100 стр. / 1,5 месяца - 123 456 руб."> <p class="work_price"><span class="book_content">100 стр. / 1,5 месяца</span><span class="book_price">123 456 руб.</span></p></label>

                <label><input type="checkbox" class="chekbox_rd_button" value="Нон-фикшн. 200 стр. / 1,5 месяца - 123 456 руб."> <p class="work_price"><span class="book_content">100 стр. / 1,5 месяца</span><span class="book_price">123 456 руб.</span></p></label>

                <label><input type="checkbox" class="chekbox_rd_button" value="Нон-фикшн. 300 стр. / 1,5 месяца - 123 456 руб."> <p class="work_price"><span class="book_content">100 стр. / 1,5 месяца</span><span class="book_price">123 456 руб.</span></p></label>
            </div>
    ...
    <div data-simplebar class="modal_center__container right_stuck_modal">
        ...
        <form action="#" onsubmit="return false;">
            ...
            <div class="wrapper_janr">
                ...
                <label><input type="checkbox" class="chekbox_rd_button" value="100 стр. / 1,5 месяца - 123 456 руб."> <p class="work_price"><span class="book_content">100 стр. / 1,5 месяца</span><span class="book_price">123 456 руб.</span></p></label>

                <label><input type="checkbox" class="chekbox_rd_button" value="200 стр. / 1,5 месяца - 123 456 руб."> <p class="work_price"><span class="book_content">100 стр. / 1,5 месяца</span><span class="book_price">123 456 руб.</span></p></label>

                <label><input type="checkbox" class="chekbox_rd_button" value="300 стр. / 1,5 месяца - 123 456 руб."> <p class="work_price"><span class="book_content">100 стр. / 1,5 месяца</span><span class="book_price">123 456 руб.</span></p></label>
            </div>
            <div class="wrapper_janr">
...
<footer>
    ...
    <!--<script src="js/plugins/jquery.inputmask.extensions.js"></script>-->
